...
namespace UnityEngine {
    ...
    public struct Quaternion {
        public float x, y, z, w;
        public Quaternion(float x, float y, float z, float w) { this.x = x; this.y = y; this.z = z; this.w = w; this.eulerAngles = default; }
        public Vector3 eulerAngles { get; set; }
    ...
    public struct Rect {
        ...
        public Rect(float x, float y, float width, float height) { this.x = x; this.y = y; this.width = width; this.height = height; this.xMin = default; this.xMax = default; this.yMin = default; this.yMax = default; this.center = default; this.size = default; }
    ...
    public struct Bounds {
        ...
        public Bounds(Vector3 center, Vector3 size) { this.center = center; this.size = size; this.extents = size * 0.5f; this.min = default; this.max = default; }
